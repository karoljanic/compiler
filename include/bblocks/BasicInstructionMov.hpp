...
class BasicInstructionMovVarToArr : public BasicInstruction {
 ...
 public:
  ...
  BasicInstructionMovVarToArr(const std::string& variableName, const std::string& arrayName, const std::string& indexVariableName,
                              std::shared_ptr<Hardware> hardware);
...
class BasicInstructionMovArrToVar : public BasicInstruction {
 ...
 public:
  ...
  BasicInstructionMovArrToVar(const std::string& arrayName, const std::string& indexVariableName, const std::string& variableName,
                              std::shared_ptr<Hardware> hardware);
...
class BasicInstructionMovNumToVar : public BasicInstruction {
 ...
 public:
  ...
  BasicInstructionMovNumToVar(uint64_t numValue, const std::string& variableName, std::shared_ptr<Hardware> hardware);
