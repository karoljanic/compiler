...
class BasicInstructionCondJumpVV : public BasicInstruction {
 ...
 public:
  ...
  BasicInstructionCondJumpVV(std::string leftVariableName, std::string rightVariableName,
                             BasicInstructionConditionType jumpCondition, std::string label, std::shared_ptr<Hardware> hardware);
