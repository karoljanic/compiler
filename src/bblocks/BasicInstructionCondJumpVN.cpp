  ...
  switch (jumpCondition) {
    case BasicInstructionConditionType::LESS: {
      auto conditionCalculation =
          Utils::generateNVSubtraction(rightNumber, leftVariableName, Hardware::registerMap[Hardware::accumulator].name);
    ...
    case BasicInstructionConditionType::LESS_EQUAL: {
      auto conditionCalculation = Utils::generateVNSubtraction(leftVariableName, rightNumber,
